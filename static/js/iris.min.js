...
!function(a, b) {
    ...
    c.fn = c.prototype = {
        ...
        getReadableContrastingColor: function(a, d) {
            ...
            if (f >= e)
                return this;
            for (var i = 0 === g.toInt()?-1 : 1; e > f && (this.incrementLightness(i)
                , f = this.getDistanceLuminosityFrom(a), 0 !== this._color && 16777215 !== this._color);
            );
            return this
        },
        a: function(a) {
